...
public class Examples {
	...
	public void test_get() {
		...
		given().contentType(ContentType.JSON).accept(ContentType.JSON).when().get("/users").then().statusCode(200).log()
				.all();
	...
	public void test_get_2() {
		...
		given().param("name", "Automation").contentType(ContentType.JSON).accept(ContentType.JSON).when()
